 ...
 * @date Mar 2, 2019
 */
public class SystemDisabledEvent extends SystemEvent
{
     ...
     * @param sysUID Unique ID of disabled system
     * @param parentGroupUID ID of parent system (or null if system
     * is not a member of any parent system)
     */
    public SystemDisabledEvent(long timeStamp, String sysUID, String parentGroupUID)
    {
    ...
    public SystemDisabledEvent(String sysUID, String parentGroupUID)
    {
        super(sysUID);
        this.parentGroupUID = parentGroupUID;
    }
