 ...
 * @date Mar 2, 2019
 */
public class SystemRemovedEvent extends SystemEvent
{
     ...
     * @param sysUID Unique ID of removed system
     * @param parentGroupUID Unique ID of parent system (or null if system
     * is not a member of any parent system)
     */
    public SystemRemovedEvent(long timeStamp, String sysUID, String parentGroupUID)
    {
    ...
    public SystemRemovedEvent(String sysUID, String parentGroupUID)
    {
        super(sysUID);
        this.parentGroupUID = parentGroupUID;
    }
