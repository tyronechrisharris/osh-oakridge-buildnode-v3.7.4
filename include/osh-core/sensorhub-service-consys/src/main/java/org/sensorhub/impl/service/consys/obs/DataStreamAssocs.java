...
public class DataStreamAssocs
{
    public static final String REL_PARENT = "system";
    public static final String REL_OBSERVATIONS = "observations";
    
    IObsSystemDatabase db;
    IdEncoders idEncoders;
    
    
    public DataStreamAssocs(IObsSystemDatabase db, IdEncoders idEncoders)
    {
        this.db = db;
    ...
    public ResourceLink getCanonicalLink(String dsId)
    {
        return new ResourceLink.Builder()
            .rel("canonical")
            .href("/" + DataStreamHandler.NAMES[0] + "/" + dsId)
    ...
    public ResourceLink getAlternateLink(String dsId, ResourceFormat format, String formatName)
    {
        return new ResourceLink.Builder()
            .rel("alternate")
            .title("This datastream resource in " + formatName + " format")
            .href("/" + DataStreamHandler.NAMES[0] + "/" + dsId)
            .withFormat(format)
            .build();
    }
    ...
    public ResourceLink getParentLink(IDataStreamInfo ds, ResourceFormat format)
    {
    ...
    public ResourceLink getObservationsLink(String dsId, ResourceFormat format)
    {
        return new ResourceLink.Builder()
            .rel(REL_OBSERVATIONS)
            .title("Observations")
            .href("/" + DataStreamHandler.NAMES[0] + "/" + dsId + "/" + ObsHandler.NAMES[0])
            .withFormat(format)
            .build();
    }
}
