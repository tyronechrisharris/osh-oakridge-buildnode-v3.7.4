 ...
 * @since Feb 26, 2022
 */
public class DeploymentEventBindingJson extends ResourceBindingJson<Long, SystemEvent>
{
    
    
    DeploymentEventBindingJson(RequestContext ctx, IdEncoders idEncoders) throws IOException
    {
