 ...
 * @date Sep 23, 2019
 */
public class MVObsSystemDatabaseConfig extends MVDatabaseConfig
{
    ...
    public MVObsSystemDatabaseConfig()
    {
        this.moduleClass = MVObsSystemDatabase.class.getCanonicalName();
    }
}
