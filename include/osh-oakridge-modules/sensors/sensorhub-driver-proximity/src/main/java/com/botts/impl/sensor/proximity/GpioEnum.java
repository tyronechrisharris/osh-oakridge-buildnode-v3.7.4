...
public enum GpioEnum {
    ...
    /**
     * Constructor for GpioEnum.
     *
     * @param value the integer value of the GPIO pin
    ...
    /**
     * Gets the integer value of the GPIO pin.
     *
     * @return the integer value of the GPIO pin
     */
    public int getValue() {
        return this.value;
    }
     ...
     *
     * @return the name of the GPIO pin
     */
