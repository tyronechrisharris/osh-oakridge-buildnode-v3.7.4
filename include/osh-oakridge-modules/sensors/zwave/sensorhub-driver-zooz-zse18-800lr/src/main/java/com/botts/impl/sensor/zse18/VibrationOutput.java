 ...
 * @since 09/09/24
 */
public class VibrationOutput extends AbstractSensorOutput<ZSE18Sensor> {

    private static final String SENSOR_OUTPUT_NAME = "ZSE18 Vibration Alarm";

    private static final Logger logger = LoggerFactory.getLogger(VibrationOutput.class);
     ...
     */
    VibrationOutput(ZSE18Sensor parentSensor) {
...
//                                .addAllowedValues("ON", "OFF"))
    ...
    public void onNewMessage(boolean isVibrationAlarm) {
        ...
        try {
            ...
            dataBlock.setBooleanValue(1, isVibrationAlarm);

            latestRecord = dataBlock;

            latestRecordTime = System.currentTimeMillis();

            eventHandler.publish(new DataEvent(latestRecordTime, VibrationOutput.this, dataBlock));
