 ...
 * @since 09/09/24
 */
public class BatteryOutput extends AbstractSensorOutput<ZSE18Sensor> {

    private static final String SENSOR_OUTPUT_NAME = "ZSE18 Battery Level";
     ...
     */
    BatteryOutput(ZSE18Sensor parentSensor) {
