 ...
 * @author nelson85
 */
public class VehicleClassWriter extends ObjectWriter<VehicleClass>
{
  public VehicleClassWriter()
  {
  ...
  {
    attributes.add("id", ((VehicleClassImpl) object).getInfo().getId());
  }

  @Override
  public void contents(VehicleClass object) throws WriterException
  {
    VehicleClassImpl impl = (VehicleClassImpl) object;
