...
public class IntegerArrayContents extends ObjectReader<int[]>
{
  ...
  @Override
  public int[] contents(String textContents) throws ReaderException
  {
    try
    {
      return ArrayEncoding.decodeIntegers(textContents);
    }
    catch (ParseException ex)
    {
      throw new ReaderException("Error decoding int[]\n " + textContents, ex);
    }
  }
