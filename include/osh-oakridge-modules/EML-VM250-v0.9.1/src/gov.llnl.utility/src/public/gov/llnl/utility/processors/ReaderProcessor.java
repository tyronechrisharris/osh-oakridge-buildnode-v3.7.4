...
//<editor-fold desc="internal" defaultstate="collapsed">
  ...
  {
    TreeMap<String, ExecutableElement> out = new TreeMap<>();
  ...
  private void check(Element element)
  {
    ...
    if (decl.referenceable() && decl.contentRequired())
    {
...
//        writer.println("import org.xml.sax.Attributes;");
        ...
        writer.println("  contentRequired = " + decl.contentRequired() + ",");
        if (contents != null)
        ...
        writer.println("  public " + declName + " start(org.xml.sax.Attributes attributes) throws ReaderException");
        writer.println("  {");
        ...
        // Handlers
        writer.println("  @Override");
        writer.println("  public ElementHandlerMap getHandlers() throws ReaderException");
        writer.println("  {");
        if (contents != null || elements.isEmpty())
        {
        ...
        else
        {
          ...
          for (ElementDecl e : elements)
          {
            ...
            {
              writer.println("    builder.anyElement(" + contentType + ".class)");
        ...
        if (contents != null)
        {
          writer.println("  public " + declName + " contents(String textContents) throws ReaderException");
          writer.println("  {");
          ...
          if (param0.asType().toString().equals("java.lang.String"))
            writer.println("   getObject()." + methodName + "(textContents);");
          else
          {
            writer.println("   getObject()." + methodName
...
//        writer.println("  public Class<" + declName + "> getObjectClass()");
//        writer.println("  {");
//        writer.println("    return " + declName + ".class;");
//        writer.println("  }");
        writer.println("}");
      }
    }
