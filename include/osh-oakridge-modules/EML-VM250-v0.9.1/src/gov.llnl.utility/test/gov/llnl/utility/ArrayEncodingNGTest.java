...
public class ArrayEncodingNGTest
{
  ...
  {
    System.out.println("ArrayEncoding Ctor");
  ...
  {
    System.out.println("encodeShorts");
  ...
  {
    System.out.println("encodeIntegers");
    int[] values = null;
    String expResult = "";
  ...
  {
    System.out.println("encodeLongs");
    long[] values = null;
    String expResult = "";
  ...
  {
    System.out.println("encodeFloats");
    float[] values = null;
    String expResult = "";
  ...
  {
    System.out.println("encodeDoubles");
    double[] values = null;
    String expResult = "";
  ...
  {
    System.out.println("encodeDoublesAsFloats");
  ...
  {
    System.out.println("convertToFloats");
    double[] values = new double[]
    {
      -456140859.766920D, -522321888.606352D, -344911454.874654D, -866595362.207846D, -695333209.518432D, -580729553.595671D, -354571538.535899D, -403660656.508311D
    };
    float[] expResult = new float[]
    {
      (float) -456140859.766920D, (float) -522321888.606352D, (float) -344911454.874654D, (float) -866595362.207846D, (float) -695333209.518432D, (float) -580729553.595671D, (float) -354571538.535899D, (float) -403660656.508311D
    };
  ...
  {
    System.out.println("decodeFloats");
  ...
  {
    System.out.println("decodeDoubles");
  ...
  {
    System.out.println("decodeIntegers");
  ...
  {
    System.out.println("decodeLongs");
  ...
  {
    System.out.println("toStringDoubles");
    double[] values = new double[]
    {
  ...
  {
    System.out.println("parseFloats");
  ...
  {
    System.out.println("parseDoubles");
    String str = "";
  ...
  {
    System.out.println("parseIntegers");
    String str = "";
  ...
  {
    System.out.println("encodeFloatsArray");
  ...
  {
    System.out.println("encodeDoublesArray");
  ...
  {
    System.out.println("decodeFloatsArray");
  ...
  {
    System.out.println("decodeDoublesArray");
