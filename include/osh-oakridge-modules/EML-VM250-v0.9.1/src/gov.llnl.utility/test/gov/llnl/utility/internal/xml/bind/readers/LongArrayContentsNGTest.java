...
public class LongArrayContentsNGTest
{
  ...
  /**
   * Test of createSchemaElement method, of class LongArrayContents.
   */
  @Test
  ...
  /**
   * Test of getObjectClass method, of class LongArrayContents.
   */
  @Test
  ...
  /**
   * Test of contents method, of class LongArrayContents.
   */
  @Test
  public void testContents() throws Exception
  {
    ...
    LongArrayContents instance = new LongArrayContents();
    long[] expResult = null;
    long[] result = instance.contents(textContents);
    assertEquals(result, expResult);
    // TODO review the generated test code and remove the default call to fail.
    fail("The test case is a prototype.");
  }
