...
public class PoissonRandom extends RandomFactory implements Serializable
{
  ...
  public int draw(double lambda)
  {
    if (lambda <= 0)
      return 0;
    if (lambda > 5)
      return this.drawHormannPoisson(lambda);
    return this.drawCumulativePoisson(lambda);
  }
...
//    {
//      pr.drawCumulativePoisson(5);
//    }
//    for (int i=0;i<1000000;++i)
//    {
//      pr.drawHormannPoisson(5);
//    } 
//  }
  public int[] draw(double lambda[])
  {
  ...
  public int drawCumulativePoisson(double lambda)
  {
...
//
  public int drawHormannPoisson(double lambda)
  {
...
//  {
//    PoissonRandom r= new PoissonRandom();
//    
//    r.setSeed(0);
//    for (int i=0;i<10;i++)
//      System.out.println(r.draw(10));
//        for (int i=0;i<10;i++)
//      System.out.println(r.draw(50));
//  }
  @Override
