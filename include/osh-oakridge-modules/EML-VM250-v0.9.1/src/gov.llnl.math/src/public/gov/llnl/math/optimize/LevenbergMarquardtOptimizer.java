...
public class LevenbergMarquardtOptimizer implements Serializable
{
  ...
  @Debug public double alpha = 0.2; // used to control the descent rate
  @Debug public int iterations = 100;
  // Stored for plotting purposes
  @Debug public int regionStart;
  @Debug public int regionEnd;
  public boolean limitRange;
  ObjectiveFunction objective = new GaussianFitterObjective();
  // State variables
  @Debug public double[] input;  // used to debug failures 
  @Debug public double[] working;
  @Debug public double[] k;
