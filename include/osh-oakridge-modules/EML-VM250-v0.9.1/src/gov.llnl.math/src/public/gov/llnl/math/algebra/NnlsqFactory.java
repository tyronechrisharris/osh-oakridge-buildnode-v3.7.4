...
import gov.llnl.math.internal.algebra.NnlsqImpl;
import gov.llnl.math.matrix.Matrix;
import gov.llnl.math.parallel.ParallelProcessor;
import gov.llnl.utility.annotation.Debug;

/**
 * Nonnegative Least Squares Solver. PURPOSE: To solve a NNLS problem with big
 * ratio between the number of columns and the number of rows efficiently.
...
//    ws.setProcessor(processor);
  ...
  @Debug public NnlsqImpl workspace;
