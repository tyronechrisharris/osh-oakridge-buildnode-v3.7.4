 ...
 */
@Internal
public class MatrixOpDivide
{

  // FIXME, it seems like we need to throw an exception on a failure.  
  // Nothing is checking the return code.
  /**
...
//    {
//      throw Exceptions.context(ex).put("C", Cp).put("A", Ap).get();
//    }
  }
